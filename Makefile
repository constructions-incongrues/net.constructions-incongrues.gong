...
urls: # Affichage de la liste des URL publiques
	...
	@echo "  Application"
	@echo
	@echo "    \033[36mPage d'accueil\033[0m : http://net.constructions-incongrues.gong.localhost"
	@echo
	@echo "  Outils"
	@echo
	@echo "    \033[36mAdminer\033[0m : http://adminer.net.constructions-incongrues.gong.localhost"
	@echo "    \033[36mPortainer\033[0m : http://portainer.net.constructions-incongrues.gong.localhost"
	@echo "    \033[36mTraefik\033[0m : http://traefik.net.constructions-incongrues.gong.localhost"
	@echo